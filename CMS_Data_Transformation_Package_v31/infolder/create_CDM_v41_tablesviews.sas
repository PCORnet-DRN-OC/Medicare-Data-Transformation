...
%macro create_cdm_v41_tablesviews;
  ...
  %end;
	...
	ods listing close;
    ods pdf file="&epath.outfolder/create_cdm_v41_tablesviews.pdf" style = PCORNET_CDMTL;	
  ...
  data run_time_tracking;
	 ...
	 if programs="PCORNET CDM v41 ETL" then do;
        end_time=datetime();
